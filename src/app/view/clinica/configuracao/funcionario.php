    ...
    ?>
        ...
        <div class="config">
            <ul class="nav nav-tabs justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../configuracao/funcionario.php">Funcionario</a>
                </li>
                <li class="nav-item">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            $resultado = getEmployee($idClinica);
                            foreach ($resultado as $dados) {
                                ...
                                <td>
                                    <a href="../../../core/excluiFuncionario.php?id=' . $dados['id'] . ' && idClinica=' . $idClinica . '">
