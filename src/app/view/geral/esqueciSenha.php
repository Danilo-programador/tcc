    ...
    <div class="container">
        <section class="">
            <div class="w-75 p-3 border justify-items-center justify-content-center">
                <div class="m-2">
                <p class="fw-normal fs-2">Esqueci senha</p>
                </div>
              <form class="row g-3" action="../../core/esqueciSenha.php" method="POST">
                <div class="col-mb-3">
                   <label for="inputNome" class="form-label">E-mail:</label>
                   <input type="email"  name="email" class="form-control" id="inputEmail4" maxlength="40" required/>
                  </div>
                  <div class="col-mb-3">
                      <label for="inputEmail" class="form-label">Cpf:</label>
                      <input type="text"  name="cpf" class="form-control" id="inputPassword4" maxlength="12" required/>
                  </div>
                  <div class="col-mb-3">
                      <label for="inputEmail" class="form-label">Senha Nova:</label>
                      <input type="password"  name="senhaNova" class="form-control" id="inputPassword4" maxlength="20" required/>
                  </div>
                <div class="col-12">
                  <input type="submit" name="enviar" value="Enviar" class="btn btn-primary w-25">
                </div>
              </form>
            </div>
          </section>
                    ...
                    <form class="row g-3" method="POST" action="../../core/login.php">
                        ...
                        <div>
                            <div class="text-center">
                                <a href="esqueciSenha.php" class="">Esqueci minha senha</a>
                            </div>
                            <div class="text-center">
